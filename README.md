...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/bgauduch/dotfiles)
...
Public repo — the one-liner clones over HTTPS with no auth needed.

**Try it without touching your machine:** a throwaway sandbox (the CI image itself) runs
the whole env in a container — terminal, browser VS Code, or Codespaces. See
[`demo/`](demo/README.md).
